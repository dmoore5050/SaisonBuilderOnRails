Feature: User can add a recipe
  ...
  Scenario: Happy Home Path
    ...
    And I find and choose "Pilsner" for "Ingredient"
    And I find and fill in "8" for "Quantity"
  ...
  Scenario: Happy Hoppy Build Path
    ...
    And I fill in "149F" for "@"
    And I fill in "90 mins" for "Boil length"
    And I find and choose "Saaz" for "Ingredient"
    And I find and fill in "1" for "Quantity"
    And I find and choose "Boil" for "Usage"
    And I find and fill in "60 mins" for "Duration"
    And I press "Add Recipe"
  ...
  Scenario: Happy Yeasty Build Path
    ...
    And I fill in "149F" for "@"
    And I fill in "90 mins" for "Boil length"
    And I find and choose "Dupont Strain" for "Ingredient"
    And I find and fill in "1" for "Quantity"
    And I find and choose "Primary" for "Usage"
    And I press "Add Recipe"
    And I click "New Saison"
    Then I should see "New Saison"
