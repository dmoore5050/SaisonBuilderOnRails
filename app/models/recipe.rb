class Recipe < ActiveRecord::Base
  attr_accessible :name, :boil_length, :primary_fermentation_temp, :description, :user_id, :user, :batch_size, :mash_length, :mash_temp, :recipe_ingredients_attributes, :notes, :og, :fg, :efficiency
